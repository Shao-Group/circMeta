...
public:
	...
	vector<AI3> circ_frgs;				// circ fragments <hit1, hit2, type>, type: -1: cannot be bridged; 0: to-be-bridged; 1: bridge with empty; 2: bridge with extra splices
...
public:
	...
	int count_unbridged_circ();
	int update_bridges_circ(const vector<int> &frlist, const vector<int32_t> &chain, int strand);
